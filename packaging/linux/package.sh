...
mkdir -p "$bundle_dir/share/applications" "$bundle_dir/share/icons/hicolor/256x256/apps" "$bundle_dir/share/mime/packages"
...
cp packaging/linux/zerium.xml "$bundle_dir/share/mime/packages/zerium.xml"
